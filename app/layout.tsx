...
export const metadata: Metadata = {
  ...
  description:
    'Modern, mobil-első marketing oldal bérbeadóknak. Royal Indigo színpaletta, magyar piacra.',
  openGraph: {
    title: 'Micro-Landlord OS Lite – Lakáskiadás okosan',
    description:
      'Modern, mobil-első marketing oldal bérbeadóknak. Royal Indigo színpaletta, magyar piacra.',
    ...
    <html lang="hu" className="theme-dark">
      <head>
        ...
        <meta
          ...
          content="Modern, mobil-első marketing oldal bérbeadóknak. Royal Indigo színpaletta, magyar piacra."
        />
